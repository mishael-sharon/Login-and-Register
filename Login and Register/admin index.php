    ...
    <div class="container py-5 h-100">
      <div class="row d-flex align-items-center justify-content-center h-100">
        <div class="col-md-8 col-lg-7 col-xl-6">
          <img src="images.png" class="img-fluid" alt="Phone image" height="300px" width="600px">
        </div>
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          <form action="admin login.php" method="post">
            ...
            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
              <input type="submit" value="Sign in" name="login" class="btn btn-warning btn-lg text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600;background-color: #008CBA" />
            </div>

          </form><br>
          <p align="center"><a href="index.php" class="text-warning" style="font-weight:600;text-decoration:none;">Back To Main Login Page</a></p>
          <!-- <p align="center"><a href="admin register.php" class="text-warning" style="font-weight:600;text-decoration:none;">register now</a></p> -->
        </div>
      </div>
    </div>
  </section>
