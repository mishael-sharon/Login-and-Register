            ...
            <div class="card-body p-md-2">
              ...
              <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">Sign up</p>
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="Admin add.php" method="post">
                  ...
                  <p align="center">i have already account <a href="Admin index.php" class="text-warning" style="font-weight:600; text-decoration:none;">Login</a></p>
                </div>
