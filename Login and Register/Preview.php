  ...
  <div class="col-sm-1">
    ...
    <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
    	<?php 
         ...
         <div class="row">
          <div class="col-2">
            <img src="images.png" class="img-fluid" class="center">
          </div>
           <div class="col">
              <div class="main-heading">St. Vincent Pallotti College of Engineering and Technology</div>
     <p class="sub-heading">Established in 2004 by the Nagpur Pallottine Society. 
      The College is accredited by NAAC with A grade. The College is affiliated to Nagpur University approved by Director of Technical Education, Mumbai and AICTE, Government of India.</p>
      <div class="address">St. Vincent Pallotti College of Engineering & Technology, Gavsi Manapur, Wardha Road, Nagpur, Maharashtra India, - Pin : 441108
</div>
         <p class="email"> <a href="https://www.stvincentngp.edu.in/">https://www.stvincentngp.edu.in/</a>, <a href ="info@stvincentngp.edu.in"> info@stvincentngp.edu.in</a></p>
          </div>
          <div class="col-sm-12">
            <hr class="hrcls"> 
          </div>
