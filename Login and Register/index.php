      ...
      <div class="row d-flex align-items-center justify-content-center h-100">
        ...
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          <form action="login.php" method="post">
            ...
            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
            <p align="center"><a href="admin index.php" style="font-weight:600;text-decoration:none;">Admin Login</a></p>
            </div>

          </form><br>
          <p align="center">i don't have any account <a href="register.php" style="font-weight:600;text-decoration:none;">Register Here</a></p>
        </div>
      </div>
    </div>
  </section>
