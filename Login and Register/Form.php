...
<div class="row">
   ...
   <div class="col-sm-4">
    ...
    <div class="mb-3 row">
   <div class="col-sm-4">
      <label class="lable">JEE Score </label>
    </div>
     <div class="col-sm-8">
      <input type="text" name="JEE" maxlength="10" class="form-control" required>
    </div>
    </div>
    <div class="mb-3 row">
   <div class="col-sm-4">
      <label class="lable">CET Score </label>
    </div>
     <div class="col-sm-8">
      <input type="text" name="CET" maxlength="10" class="form-control" required>
    </div>
    </div>
<div class="mb-3 row">
   <div class="col-sm-4">
...
<div class="mb-3 row">
   <div class="col-sm-4">
    ...
    <div class="mb-3 row">
   <div class="col-sm-4">
      <label class="lable">Course option</label>
    </div>
     <div class="col-sm-8">
     <select name="course" class="form-control" required>
        ...
        <option value="Department of Computer Science and Business Systems(TCS)">Department of Computer Science and Business Systems(TCS)</option>
     </select>
    </div>
    </div>
    </div>
    ...
    <!-- <div class="mb-3 row">
   <div class="col-sm-4">
      <label class="lable">Course option_2</label>
    </div>
     <div class="col-sm-8">
     <select name="course" class="form-control" required>
      <option value="">Select Course</option>
    ...
    <div class="mb-3 row">
   <div class="col-sm-4">
      <label class="lable">Course option_3</label>
    </div>
     <div class="col-sm-8">
     <select name="course" class="form-control" required>
      <option value="">Select Course</option>
    ...
    <div class="mb-3 row">
   <div class="col-sm-4">
      <label class="lable">Course option_4</label>
    </div>
     <div class="col-sm-8">
     <select name="course" class="form-control" required>
      <option value="">Select Course</option>
    ...
    <div class="mb-3 row">
   <div class="col-sm-4">
      <label class="lable">Course option_5</label>
    </div>
     <div class="col-sm-8">
     <select name="course" class="form-control" required>
      <option value="">Select Course</option>
